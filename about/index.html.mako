...
<h2>About</h2>
<p>
    From Python Import Podcast is dedicated to sharing thoughts, opinions,
    rants, and intelligent discussion about all things Python. We have a
    special focus on practical application, but like all bitheads, we stray
    far and wide, from design theory to the best way to configure vim.
</p>
